...
class LoginView extends ViewTemplate {
  ...
  /**
   * Signals that login  was successful. This will notify the user and redirect the client.
  ...
  /**
   * Signals that login was unsuccessful. This will notify the user and refresh the page.
   * WARNING: This will also kill the call stack by calling die().
   */
  ...
  /**
   * Signals that logout was successful. This will notify the user and redirect the client.
   * WARNING: This will also kill the call stack by calling die().
   */
