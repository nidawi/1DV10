...
class Database {
  ...
  // TODO: Raise abstraction level of this class.
  // I would like to have high-abstraction methods like "update" and "delete" that hide the sql parts.
  // I would also like the database to implement an interface for simple substitution.
